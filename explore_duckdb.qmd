...
d_site <- tbl(con_dk, "site") |> 
  collect()

# dbGetQuery(con_dk, "SELECT to_hex(h3_latlng_to_cell(37.7887987, -122.3931578, 10)) AS h3_res10;") # 4

# add h3_res10 column to site table
dbExecute(con_dk, "ALTER TABLE site ADD COLUMN h3_res10 BIGINT;")

# update h3_res10 column with h3 index
dbExecute(con_dk, "
  UPDATE site
  SET h3_res10 = h3_latlng_to_cell(latitude, longitude, 10);")
