...
calcofi:
  ...
  dataset_meta:
    ...
    citation_main: ""
    link_calcofi_org: ""
    # the PFEG ERDDAP table, not the Datazoo catalog page (which still answers
    # 200 but is on its way out; it survives as prose in `description` above) —
    # per the 2026-08 db-viz-station feedback round (db-viz-station#15). On the
    # oceanview host: coastwatch serves the same CAC_FI_SBAS_obs dataset but was
    # unreachable outright when checked (2026-08-24), and oceanview is the host
    # the ichthyo tow links already use. Once a release carries this, delete the
