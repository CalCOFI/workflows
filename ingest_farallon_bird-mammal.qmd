...
# mammals -> worms: via the override table)
...
core <- emit_core_tables(
  con, "calcofi_bird_mammal_census",
  measurement_taxon = mt_taxon, overrides = tx_over)
cat(glue(
...
build_metadata_json(
  ...
  metadata_derived_csv = c(
    ...
    here("metadata/calcofi/bird_mammal_census/metadata_derived.csv")),
