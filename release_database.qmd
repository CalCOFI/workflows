...
retire_tbls <- setdiff(DBI::dbListTables(con_wdl), core_keep)
for (t in retire_tbls) {
  DBI::dbExecute(con_wdl, glue('DROP VIEW IF EXISTS "{t}"'))
  DBI::dbExecute(con_wdl, glue('DROP TABLE IF EXISTS "{t}"'))
}
