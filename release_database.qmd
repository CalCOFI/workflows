...
if (file.exists(meta_json_path)) {
  ...
  # with the reason (same_bottles · replicate_vs_mean · underway_vs_cast · pre_qc_twin): P01
  # identity says two series name the same quantity, never that they may be pooled — the CTD files'
  # own bottle table is plausibly the same physical bottles as the bottle dataset.
