...
## Read GoogleSheet of Repositories
...
- [Protocol | sitemaps.org](https://www.sitemaps.org/protocol.html)\
  * `loc`: dataset url
  * `lastmod`: today's date; TODO: change to dataset last modified date
  * `changefreq`: skipping; valid values: always, hourly, daily, weekly, monthly, yearly, never
  * `priority`: skipping; valid values: 0 to 1, e.g. 0.8
...
[`https://calcofi.io/workflows/datasets/sitemap.xml`](https://calcofi.io/workflows/datasets/sitemap.xml):
