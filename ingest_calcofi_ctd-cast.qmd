...
# it is a different station: 100/110/120 shipped as 000.0/010.0/020.0 in the 2607
# preliminary file until the provider fixed it on 2026-09-14 (CalCOFI/workflows#104),
# and the distance filter above then dropped every offshore cast on lines 80-93.3
# as a position error — quietly, one row in a table of cruises. So test the dropped
# scans for exactly that signature: an inshore station number (< 30) whose cast
# sits within the cutoff of station number + 100. Any match stops the render.
d_trunc <- pts |>
