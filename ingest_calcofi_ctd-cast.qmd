...
# converted to YYYY-MM-NODC later via convert_cruise_key_format())
...
geom_tbls_ctd <- DBI::dbGetQuery(con,
  "SELECT DISTINCT table_name FROM information_schema.columns
   WHERE data_type LIKE 'GEOMETRY%'")$table_name
dm_tbls_ctd <- setdiff(DBI::dbListTables(con), geom_tbls_ctd)

tryCatch({
  dm_ctd <- dm_from_con(con, table_names = dm_tbls_ctd, learn_keys = FALSE) |>
    dm_add_pk(ctd_summary, ctd_summary_uuid) |>
    dm_add_pk(measurement_type, measurement_type)
