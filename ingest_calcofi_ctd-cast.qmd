...
# first-pass plausible physical ranges for oceanographic CTD sensors. Deliberately
# generous: the point is to catch impossible values, not to police oceanography.
plaus <- tribble(
  ~measurement_type,              ~lo,    ~hi,
...
core <- emit_core_tables(con, "calcofi_ctd-cast", taxa = FALSE)
cat(glue(
