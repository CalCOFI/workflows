...
librarian::shelf(
  DBI, dm, DT, glue, googledrive, here, janitor, jsonlite, lubridate, purrr, 
  readr, rlang, tibble, tidyr, uuid,
  quiet = T)
...
# define paths ---
workflow     = "ingest_noaa-calcofi-db"
workflow_url = "https://calcofi.io/workflows/ingest_noaa-calcofi-db.html"
