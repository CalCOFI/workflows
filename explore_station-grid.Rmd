...
for (res_m in resolutions_km * 1000){
  r_tmpl <- raster(
    xmn = b$xmin, xmx = b$xmax, 
    ymn = b$ymin, ymx = b$ymax,
    resolution = res_m,
    crs = 3857)
  r_sta <- rasterize(stations_crs, r_tmpl, fun="count")
...
dx = 1000*100 # 100 km width
dy = 1000*100 # 100 km height
