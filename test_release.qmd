...
taxa_res <- if (is.null(taxa_txt)) {
  ...
  dplyr::bind_rows(
    ...
    tx_row(glue("taxa: schema_version is 1.0 [{taxa_rec$schema_version %||% 'absent'}]"),
           identical(taxa_rec$schema_version, "1.0"),
           "built by a calcofi4db older than 4.9.0"),
...
meas_res <- if (is.null(meas_txt)) {
  ...
  dplyr::bind_rows(
    ...
    mm_row(glue("measurements: schema_version is 1.0 [{meas_rec$schema_version %||% 'absent'}]"),
           identical(meas_rec$schema_version, "1.0"),
           "built by a calcofi4db older than 4.12.0"),
