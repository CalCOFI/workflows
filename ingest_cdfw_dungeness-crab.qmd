...
calcofi:
  ...
  dataset_meta:
    ...
    link_data_source: ""
    link_others: []
    # ASSERTED, and the other of the two left in the repo. Coverage is measured
    # at release time by calcofi4db::observed_coverage() from the assembled
    # core — but this dataset is `in_release: false`, so it never reaches the
    # core and the release cannot measure it. Its card on calcofi.io/workflows
    # would otherwise go blank. DELETE BOTH KEYS when Q01 is answered and this
    # flips into the release; the measured values are then 1949-04 to 2014-05
    # and 33.5-51.0°N, 164.1-118.6°W.
