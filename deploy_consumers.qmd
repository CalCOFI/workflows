...
consumer_status <- function() {
  tibble::tribble(
    ...
    # both were outside the deploy until 2026-08-25; ctd-viz had served a
    # 2026-05-15 database through three releases with nothing here to say so
    "ctd-viz",        ssh_out("stat -c %y /share/data/ctd-viz/ctd-viz.duckdb 2>/dev/null | cut -c1-16"),
                      "database mtime (carries no version)",
    "ctd-qaqc",       ssh_out("stat -c %y /share/data/ctd-qaqc/ctd-qaqc.duckdb 2>/dev/null | cut -c1-16"),
                      "database mtime (carries no version)",
    ...
    mutate(http = c(http_code("https://app.calcofi.io/db-viz-hex/"),
                    ...
                    http_code("https://app.calcofi.io/ctd/"),
                    http_code("https://app.calcofi.io/ctd-qaqc/"),
