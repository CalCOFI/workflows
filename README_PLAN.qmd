...
4. **Next steps to update DuckLakes**:
   - Re-render `ingest_swfsc.noaa.gov_calcofi-db.qmd` (rebuilds wrangling DB + parquet)
   - Re-render `ingest_calcofi.org_bottle-database.qmd` (no structural changes, optional)
   - Re-render `merge_ichthyo_bottle.qmd` (picks up new parquet schema)
   - Upload new parquet outputs to GCS
   - Create new frozen release (v2026.03 or v2026.02.1)
