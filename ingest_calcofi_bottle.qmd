...
adjacency list. Cast conditions and the cast's `bottom_depth_m` become
`sample_measurement` (they describe the event, not an observation); the long
`bottle_measurement` values become `obs` at `realm = 'env'`.
