...
Reflected coordinates match no grid cell, and `append_obs()` below filters
`WHERE s.grid_key IS NOT NULL` while the `sample` arm does not. So four of those
cruises (`2013-01-3322`, `2013-04-3322`, `2014-02-3322`, `2014-04-32I1`) reached
release v2026.08.08 as **11,762 underway samples with zero observations**, with
1,728,548 measurements and 1,147,814 `obs_mets_full` rows behind them. The fifth,
