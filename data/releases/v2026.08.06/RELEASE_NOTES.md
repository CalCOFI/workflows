# CalCOFI Database Release v2026.08.06
...
dbGetQuery(con, "
  SELECT * FROM read_parquet(
    'https://storage.googleapis.com/calcofi-db/ducklake/releases/v2026.08.06/parquet/ichthyo.parquet')
  LIMIT 10")
```
...
```r
library(calcofi4r)
con <- cc_get_db(version = 'v2026.08.06')
```
