# CalCOFI Database Release v2026.06.07
...
dbGetQuery(con, "
  SELECT * FROM read_parquet(
    'https://storage.googleapis.com/calcofi-db/ducklake/releases/v2026.06.07/parquet/ichthyo.parquet')
  LIMIT 10")
```
...
```r
library(calcofi4r)
con <- cc_get_db(version = 'v2026.06.07')
```
