# CalCOFI integrated database release v2026.04.03
...
**29 tables, 361,183,451 rows, 0.00 GB.**

## How to cite

> CalCOFI (2026). CalCOFI Integrated Database, release v2026.04.03 [Data set]. Scripps Institution of Oceanography, NOAA Fisheries, and California Department of Fish and Wildlife. https://calcofi.io/db-schema/?v=v2026.04.03
...
```r
con <- calcofi4r::cc_get_db(version = "v2026.04.03")
```
```python
con = calcofi4py.cc_get_db("v2026.04.03")
```
Parquet: `https://storage.googleapis.com/calcofi-db/ducklake/releases/v2026.04.03/parquet/{table}.parquet`; 
