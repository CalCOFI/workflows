...
| `cruise_summary` | 691 |  |
| `ctd_cast` | 6,065,096 |  |
| `ctd_measurement` | 233,008,709 | partitioned |
...
```r
con <- calcofi4r::cc_get_db(version = "v2026.04.08")
```
```python
con = calcofi4py.cc_get_db("v2026.04.08")
```
Parquet: `https://storage.googleapis.com/calcofi-db/ducklake/releases/v2026.04.08/parquet/{table}.parquet`; 
