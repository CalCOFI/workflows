...
**18 tables, 255,155,031 rows, 1.71 GB.**
...
```r
con <- calcofi4r::cc_get_db(version = "v2026.08.04")
```
```python
con = calcofi4py.cc_get_db("v2026.08.04")
```
Parquet: `https://storage.googleapis.com/calcofi-db/ducklake/releases/v2026.08.04/parquet/{table}.parquet`; 
