# CalCOFI integrated database release v2026.05.14
...
> CalCOFI (2026). CalCOFI Integrated Database, release v2026.05.14 [Data set]. Scripps Institution of Oceanography, NOAA Fisheries, and California Department of Fish and Wildlife. https://calcofi.io/db-schema/?v=v2026.05.14
...
```r
con <- calcofi4r::cc_get_db(version = "v2026.05.14")
```
```python
con = calcofi4py.cc_get_db("v2026.05.14")
```
Parquet: `https://storage.googleapis.com/calcofi-db/ducklake/releases/v2026.05.14/parquet/{table}.parquet`; 
