# CalCOFI Database Release v2026.05.20
...
- measurement_type (        105 rows)
- dataset (          5 rows)
- ctd_cast (  5,550,014 rows)
- ctd_thin (  5,551,571 rows)
- ctd_summary (108,396,787 rows)
...
dbGetQuery(con, "
  SELECT * FROM read_parquet(
    'https://storage.googleapis.com/calcofi-db/ducklake/releases/v2026.05.20/parquet/ichthyo.parquet')
  LIMIT 10")
```
...
```r
library(calcofi4r)
con <- cc_get_db(version = 'v2026.05.20')
```
