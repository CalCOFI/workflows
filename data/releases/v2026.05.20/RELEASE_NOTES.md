...
**Validation:** 9 pass / 0 fail / 4 skip (consumer-contract suite, 2026-05-20T13:43:32Z).

## How to cite

> CalCOFI (2026). CalCOFI Integrated Database, release v2026.05.20 [Data set]. Scripps Institution of Oceanography, NOAA Fisheries, and California Department of Fish and Wildlife. https://calcofi.io/db-schema/?v=v2026.05.20
...
- `swfsc_invert` — NOAA Fisheries SWFSC. CalCOFI Invertebrate Database. · *license pending*

## Access

```r
con <- calcofi4r::cc_get_db(version = "v2026.05.20")
```
```python
con = calcofi4py.cc_get_db("v2026.05.20")
```
Parquet: `https://storage.googleapis.com/calcofi-db/ducklake/releases/v2026.05.20/parquet/{table}.parquet`; 
