# CalCOFI Database Release v2026.03.25
...
- **Tables**: 18
- **Total Rows**: 354,898,020
- **Total Size**: 11263.2 MB
...
dbGetQuery(con, "
  SELECT * FROM read_parquet(
    'https://storage.googleapis.com/calcofi-db/ducklake/releases/v2026.03.25/parquet/ichthyo.parquet')
  LIMIT 10")
```
...
```r
library(calcofi4r)
con <- cc_get_db(version = 'v2026.03.25')
```
