# CalCOFI Database Release v2026.08.25
...
- obs_ctd_full (271,394,164 rows)
- obs_mets_full ( 19,927,416 rows)

## Total

- **Tables**: 18
- **Total Rows**: 320,265,060
...
dbGetQuery(con, "
  SELECT * FROM read_parquet(
    'https://storage.googleapis.com/calcofi-db/ducklake/releases/v2026.08.25/parquet/ichthyo.parquet')
  LIMIT 10")
```
...
```r
library(calcofi4r)
con <- cc_get_db(version = 'v2026.08.25')
```
