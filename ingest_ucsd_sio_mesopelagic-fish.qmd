...
mt_taxon <- read_csv(here("metadata/measurement_taxon.csv"), show_col_types = FALSE)
tx_over  <- read_csv(here("metadata/taxon_override.csv"),    show_col_types = FALSE)

core <- emit_core_tables(
  con, "ucsd_sio_mesopelagic-fish", measurement_taxon = mt_taxon, overrides = tx_over)
cat(glue(
...
compat <- create_compat_views(con, "ucsd_sio_mesopelagic-fish")
...
build_metadata_json(
  ...
  metadata_derived_csv = c(here("metadata/core_dictionary.csv"),
                           here("metadata/ucsd_sio/mesopelagic-fish/metadata_derived.csv")),
  output_dir = dir_parquet,
  tables     = tbls_out,
