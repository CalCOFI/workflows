...
**Goal**: Read in the "CalCOFI NOAA Fish Larvae Sizes" dataset from ERDDAP and write to Google Drive `calcofi/data/{provider}/{dataset}`.

- [ERDDAP - CalCOFI NOAA Fish Larvae Sizes - Data Access Form](https://coastwatch.pfeg.noaa.gov/erddap/tabledap/erdCalCOFIlrvsiz.html)
