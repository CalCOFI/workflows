...
- **The `Comment` column in the spec does not exist in the files.** The format
  document lists 82 columns ending in `Comment`; the shipped CSVs have 82 columns
  and no comment field. Nothing is being dropped — the spec is simply ahead of, or
  behind, the writer.
