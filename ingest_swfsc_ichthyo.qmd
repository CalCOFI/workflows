...
# convert WKB to geometry; keep geom_wkb for refresh before spatial joins
# (workaround for DuckDB spatial serialization bug that corrupts GEOMETRY
# columns after many operations in file-backed DBs)
