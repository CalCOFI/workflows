...
calcofi:
  ...
  erd:
    color: "#cdebc6"
  # swfsc invertebrate counts are folded into this ingest (see Invert section)
  additional_datasets:
    - provider: swfsc
      dataset: invert
      dataset_name: SWFSC Invertebrates
      description: >
        Invertebrate (primarily squid) counts and sizes captured in CalCOFI
        ichthyoplankton nets, processed by SWFSC.
      citation_main: "NOAA Fisheries SWFSC. CalCOFI Invertebrate Database."
      link_calcofi_org: https://calcofi.org/data/biology/invertebrates/
      link_others:
        - https://coastwatch.pfeg.noaa.gov/erddap/tabledap/erdCalCOFIinvcnt.html
        - https://coastwatch.pfeg.noaa.gov/erddap/tabledap/erdCalCOFIinvsiz.html
      coverage_temporal: 1978 to 2023
      coverage_spatial: "0-51°N, -180 to -78°W"
      tables_owned:
        - {table: invert}
---
...
parquet_stats <- write_parquet_outputs(
  ...
  tables           = dbListTables(con),
  sort_by          = list(
    ichthyo = c("species_id", "life_stage"),
