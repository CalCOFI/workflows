...
core <- emit_core_tables(
  con, "cce-lter_zooscan", measurement_taxon = mt_taxon, overrides = tx_over)
cat(glue(
...
n_exp <- dbGetQuery(con, "
  SELECT COUNT(*) FROM zooscan_measurement m JOIN zooscan_sample sp USING (sample_id)
...
compat <- create_compat_views(con, "cce-lter_zooscan")
